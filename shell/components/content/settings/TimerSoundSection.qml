...
Rectangle {
    ...
    function syncKbToCurrent() {
        ...
        for (let i = 0; i < section.sounds.length; i++) {
            if (section.sounds[i] === section.settingsManager.timerSound) {
    ...
    MouseArea {
        ...
        RowLayout {
            ...
            Text {
                text: section.settingsManager ? section.settingsManager.timerSound : "None"
    ...
    ListView {
        ...
        delegate: Rectangle {
            ...
            height: 36
            radius: 8
            property bool isCurrent: section.settingsManager && modelData === section.settingsManager.timerSound
