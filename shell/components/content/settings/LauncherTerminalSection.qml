...
Rectangle {
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            color: "transparent"
            border.width: 1
            border.color: terminalInput.activeFocus
            ...
            TextInput {
                ...
                text: section.settingsManager ? section.settingsManager.launcherTerminal : "kitty"
    ...
    Connections {
        ...
        function onLauncherTerminalChanged() {
            if (!terminalInput.activeFocus && terminalInput.text !== section.settingsManager.launcherTerminal) {
                terminalInput.text = section.settingsManager.launcherTerminal
            }
        }
    }
}
