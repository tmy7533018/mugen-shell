...
Rectangle {
    ...
    function pick(side) {
        ...
        if (settingsManager.yuraPanelSide === side) return
        settingsManager.yuraPanelSide = side
        ...
        Row {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    readonly property bool isSelected: section.settingsManager && section.settingsManager.yuraPanelSide === modelData
