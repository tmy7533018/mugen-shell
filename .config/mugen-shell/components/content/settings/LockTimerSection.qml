...
Rectangle {
    ...
    RowLayout {
        ...
        Item {
            ...
            property real value: section.settingsManager ? section.settingsManager.lockTimerMinutes : 10
            ...
            Rectangle {
                ...
                height: 16
                radius: 8
                color: section.theme ? Qt.rgba(section.theme.accent.r, section.theme.accent.g, section.theme.accent.b, lockMouseArea.pressed ? 1.0 : 0.95) : Qt.rgba(0.65, 0.55, 0.85, 0.95)
                border.width: 1
