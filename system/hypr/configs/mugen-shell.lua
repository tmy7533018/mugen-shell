...
-- hyprland.lua already resolved this; adopting the snippet from your own config leaves it unset.
local configHome = MUGEN_CONFIG_HOME or (os.getenv("HOME") .. "/.config")
